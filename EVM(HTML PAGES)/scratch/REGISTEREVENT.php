        ...
        <?php require 'utils/header.php';?>
         <div class = "content"><!--body content holder-->
            ...
            <form name="loginform" method="POST" action="REGISTEREVENTCHECK.php" >
                 ...
                 <div class="form-group">
                    Event ID
                     ...
                     include("dbcon.php");
                     session_start();
                $qry="SELECT e.EID FROM event e where e.EID NOT IN (select EID from result)";
           ...
           <div>
            ...
            $qry1="SELECT e.EID,e.NAME FROM event e where e.EID NOT IN (select EID from result)";
