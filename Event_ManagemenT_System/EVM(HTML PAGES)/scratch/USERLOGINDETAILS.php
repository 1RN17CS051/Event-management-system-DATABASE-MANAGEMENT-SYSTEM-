	...
	<?php require 'utils/header.php'; ?><!--header content. file found in utils folder-->
        <div class="content"><!--body content holder-->
            <div class="container">
                <div class="col-md-12">
<form class="form1">
    <h3><STRONG>Hello !!....  <?php echo $data['FNAME']?> <?php echo $data['LNAME']?></STRONG></h3>
   <h6> <p>USERID  : <?php  echo $data['USN']; ?></p>
    </h6>
    ...
    <div class="content"><!--body content holder-->
            <div class="container">
                <div class="col-md-12">
                    <h1><div class="button_c" align="center"><a class="example_c" href="EXPLOREEVENTS.php" >Explore Events....</a></div></h1><!--body content title-->
                    <h1 align="center">______________________________</h1>
                 <h2 align="center">Explore events...</h2>
                    <h1 align="center">_____________________________</h1>
                    
                    <h1 align="center">_____________________________</h1>
                    <h1><div class="button_c" align="center"><a class="example_c" href="REGISTEREDEVENTS.php">Registered Events</a></div></h1>
                    <h1 align="center">______________________________</h1>
