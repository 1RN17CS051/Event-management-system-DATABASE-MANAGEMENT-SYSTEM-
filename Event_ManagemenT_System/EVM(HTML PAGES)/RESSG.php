        ...
        <div class="content"><!--body content holder-->
            <div class="container">
                <div class="col-md-12"><!--body content title holder with 12 grid columns-->
                    <h1 align="center">Successfully Published Result for the Event...</h1>
                    <p align="center">Click to view!</p>
                    <h1><div class="button_c" align="center"><a class="example_c" href="ORGANIZEDEVENTS.php" >VIEW EVENTS</a></div></h1><!--body content title-->
